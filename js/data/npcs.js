...
export const NPCS = [
  {
    id:'marchande', zone:'refuge', name:'Yvenne la Cendrée', role:'marchand',
    offset:{x:-7, y:-2},
  ...
  {
    id:'forgeron', zone:'refuge', name:'Bram Poing-de-Fer', role:'forgeron',
    offset:{x:7, y:-1},
  ...
  {
    id:'emissaire', zone:'refuge', name:"Sœur Aude de l'Ordre", role:'quete',
    offset:{x:0, y:7},
