...
export const ZONES = [
  {
    ...
    floorTile:'cobble', wallTile:'pierre', accentTile:'bois', size:{w:40,h:40},
  ...
  {
    id:'cimetiere', name:'Cimetière des Cendres', kind:'dungeon', order:1, levelRange:[1,6],
  ...
  {
    id:'marais', name:'Marais Livide', kind:'dungeon', order:2, levelRange:[6,12],
  ...
  {
    id:'grottes', name:'Grottes de Montagne', kind:'dungeon', order:3, levelRange:[12,18],
  ...
  {
    id:'desert', name:'Désert de Cendres', kind:'dungeon', order:4, levelRange:[18,24],
  ...
  {
    id:'toundra', name:'Toundra Enneigée', kind:'dungeon', order:5, levelRange:[24,30],
  ...
  {
    id:'temple', name:'Temple Maudit', kind:'dungeon', order:6, levelRange:[30,36],
  ...
  {
    id:'volcan', name:'Volcan Actif', kind:'dungeon', order:7, levelRange:[36,42],
  ...
  {
    id:'catacombes_arides', name:'Catacombes Arides', kind:'dungeon', order:8, levelRange:[42,48],
  ...
  {
    id:'faille', name:"la Faille d'Ombre", kind:'dungeon', order:9, levelRange:[48,55],
