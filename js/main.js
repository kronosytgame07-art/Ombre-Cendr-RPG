...
const HERO_IMAGE_PATHS = [...CLASSES.flatMap(c=>[c.sprite, c.sheet].filter(Boolean)), 'assets/sprites/items/equipment_atlas.png', 'assets/tiles/terrain_atlas.png', 'assets/sprites/world/world_props_atlas.png'];
